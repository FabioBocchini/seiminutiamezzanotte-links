...
const Home: React.FC = () => {
  return (
    <div className="flex flex-col px-0 overflow-y-hidden ">
      ...
      <div className="bg-smam-dark text-smam-light">
      ...
      <div className="flex flex-col min-w-full px-10 py-5 bg-smam-dark text-smam-light">
        <div className="flex justify-center text-xs font-thin">© {new Date().getFullYear()} FABIO BOCCHINI</div>
      </div>
    </div>
  )
}
